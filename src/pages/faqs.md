...
<details name="faqs">
  <summary>Who's behind these awards?</summary>

Kristoffer Tjalve ([Naive Weekly](https://www.naiveweekly.com/)), Matt Klein ([Zine](https://zine.kleinkleinklein.com/)), and Matt Muir ([Web Curios](https://webcurios.co.uk/)) are the people to blame.

</details>
<details name="faqs">
  <summary>What does &ldquo;the small, poetic, creative, handmade web&rdquo; mean in practice?</summary>
...
<details name="faqs">
<summary>What sort of websites are eligible?</summary>
...
<details name="faqs">
  <summary>What sort of websites <em>aren't</em> eligible?</summary>
...
<details name="faqs">
  <summary>What about apps?</summary>
...
<details name="faqs">
  <summary>What's your position on generative AI?</summary>
...
<details name="faqs">
  <summary>How big's the prize? What's the trophy like?</summary>
...
<details name="faqs">
  <summary>Is anyone getting rich out of this?</summary>
...
<!--
<details name="faqs">
  <summary>Who are this year's judges?</summary>
  <br>
  <table id="judges">
    	<tr>
 ...
 -->
<details name="faqs" id="website">
  <summary>Who made this website?</summary>

  <p style="text-align:center"><a href="https://cheap.urls.loan">Site by CHEAP.URLS.LOAN</a></p>
  <iframe loading="lazy" style="border-radius:0.5em;width:100%;height:600px;border:none;background-color:black"
  title="cheap.urls.loan"
  src="https://cheap.urls.loan/receipt-embed.html">
  </iframe>
